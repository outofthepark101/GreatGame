...
namespace PixelCrushers.DialogueSystem.InkSupport
{
    ...
    public class DialogueSystemInkIntegration : MonoBehaviour
    {
        ...
        protected virtual void PlaySequenceFromInk(string sequence)
        {
            ...
            sequence = sequence.Replace(@"=>", @"->"); // Ink thinks -> inside strings are still diverts.
        ...
        IEnumerator PlaySequenceAtEndOfFrame(string sequence)
        {
            ...
            {
                // Barks don't have a conversationView, so just play sequence:
                sequence = sequence.Replace(SequencerKeywords.End, DialogueManager.displaySettings.subtitleSettings.minSubtitleSeconds.ToString(System.Globalization.CultureInfo.InvariantCulture));
        ...
        // [Thanks to Ryan Scott Murphy for Ink list fixes]
